...
function solution() {
    ...
    // let's implement A*, which is BFS (breadth first search, (spanning)) with a heuristic
    // this requires a stack, approach recursively, with each item in the stack being a rollup heuristic
    // follow optimal path with highest heuristic, and rollback to last highest when complete with lower
    // scores
